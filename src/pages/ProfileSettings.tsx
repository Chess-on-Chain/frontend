  ...
  return (
    <div className="min-h-screen w-full lg:max-w-7xl px-6 py-10 text-white">
      ...
      <div className="flex items-center gap-6 mb-10">
        <div className="relative w-24 h-24 rounded-full bg-secondary">
          <div className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-gray-500 flex items-center justify-center shadow-md">
        ...
        <div>
          ...
          <div className="flex items-center gap-1 mt-3 w-fit text-sm lg:text-base">
            <span className="text-white font-semibold">Rank: </span>
            <span className="px-2 py-0 5 font-bold w-fit text-sm lg:text-xl bg-secondary text-black rounded-sm">
              100
            </span>
          </div>
        </div>
      ...
      <div className="mt-14">
        ...
        <form action="" className="space-y-4 w-full lg:max-w-2xl">
          <div className="flex items-center space-x-11">
            ...
            <div className="flex-1 flex items-center space-x-4">
              <input
                ...
                name="usrname"
                id="username"
                className="w-full px-3 py-2 border border-white/20 text-white bg-black rounded"
                defaultValue="Firman"
              />
              <button
                type="button"
                className="px-4 py-2 rounded-sm bg-secondary text-black font-semibold hover:bg-secondary"
              >
                Change
              </button>
            </div>
          ...
          <div className="flex items-center space-x-9">
            ...
            <div className="flex-1 flex items-center">
              <input
                ...
                name="firstName"
                id="firstName"
                className="w-full px-3 py-2 text-white bg-black border border-white/20 rounded"
              />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-14 text-white">
            ...
            <div className="relative flex-1 flex items-center">
              <select
                name="country"
                id="country"
                className="w-full px-3 py-2 border border-white/20 bg-black text-white appearance-none"
          ...
          <div className="flex space-x-6 mt-10 py-2 items-center justify-center lg:justify-start">
            <button
              type="submit"
              className="px-6 py-2 font-semibold text-white bg-transparen border border-secondary hover:bg-secondary rounded cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-6 py-2 font-semibold text-black bg-secondary hover:bg-secondary rounded cursor-pointer"
            >
              Save All
            </button>
          </div>
